...
export const wsConnect = createAction<string, typeof FEED_CONNECT_WS>(
  FEED_CONNECT_WS
);
export const wsOpen = createAction(FEED_OPEN_WS);
export const wsGetOrder = createAction<OrdersResponse>(FEED_ORDER_WS);
export const wsClose = createAction(FEED_CLOSE_WS);
export const wsError = createAction<string, typeof FEED_ERROR_WS>(
  FEED_ERROR_WS
);
