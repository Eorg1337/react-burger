...
export const wsConnect = createAction<string, typeof ORDER_HISTORY_CONNECT_WS>(ORDER_HISTORY_CONNECT_WS);
export const wsOpen = createAction<OrdersResponse>(ORDER_HISTORY_OPEN_WS);
...
export const wsError = createAction<string, typeof ORDER_HISTORY_ERROR_WS>(ORDER_HISTORY_ERROR_WS);

export type TOrdersHistoryActions = ReturnType<typeof wsConnect>
